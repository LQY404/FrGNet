...
def register_cell(split='train'):
    ...
    if split == 'train':
        img_files = "/run/user/1000/gvfs/smb-share:server=192.168.2.221,share=fqpathotech/ lingpeng/MoNuSeg 2018 Training Data/Data2/anno_trainv4.json"
    else:
        img_files = "/run/user/1000/gvfs/smb-share:server=192.168.2.221,share=fqpathotech/ lingpeng/MoNuSegTestData/Data2/anno_testv4.json"
    # all_files = os.listdir(img_files) # ori_imgs
