...
def add_cell_config(cfg):
    ...
    cfg.split = 'train'
    cfg.data_name = ['our', 'monuseg', 'dsb', 'tnbc', 'cpm17'][0]
    cfg.mask_root = {
    ...
    cfg.MODEL.META_ARCHITECTURE = 'CellMRCNN'
    # cfg.MODEL.NUM_CLASSES = 35  # cad
    cfg.MODEL.NUM_CLASSES = 1

    # cfg.local_rank = 3
    cfg.SOLVER.IMS_PER_BATCH = 4
    if cfg.MODEL.NUM_CLASSES == 35 or cfg.MODEL.NUM_CLASSES == 1 and 1 == 0:
